...
if (vehicle _caller != _caller) then {_caller action ["GetOut", vehicle _caller]; diag_log("P2DriveByDebug: Got Out"); sleep 0.5};
...
_caller setVehicleInit "this switchMove 'aidlpknlmstpslowwrfldnon_player_idlesteady02'; diag_log('P2DriveByDebug: MoveSwitch');";
processInitCommands; 
