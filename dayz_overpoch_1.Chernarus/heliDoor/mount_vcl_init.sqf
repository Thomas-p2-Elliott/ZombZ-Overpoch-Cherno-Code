...
{ 	
		...
		{	
			switch (typeOf _vcl) do {
				case "MH60S": {_load = _vcl addAction ["Move to rear door position", "heliDoor\mount_vcl.sqf","", 0, false, true];};
				case "MH60S_DZ": {_load = _vcl addAction ["Move to rear door position", "heliDoor\mount_vcl.sqf","", 0, false, true];};
				case "MH60S_DZE": {_load = _vcl addAction ["Move to rear door position", "heliDoor\mount_vcl.sqf","", 0, false, true];};
