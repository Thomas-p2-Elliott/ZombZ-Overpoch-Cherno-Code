...
P2DZ_mH = 		["1", "Bandits have overrun a UN campsite!", _gps, "US_WarfareBFieldhHospital_Base_EP1"];
...
P2DZ_mH = 		["1", "The UN campsite is under survivor control!", _gps, "US_WarfareBFieldhHospital_Base_EP1"];
publicVariable 	"P2DZ_mH";
