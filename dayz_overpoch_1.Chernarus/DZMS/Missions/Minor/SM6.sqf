...
P2DZ_mH = ["2", "A bandit weapons truck has been crashed!", _gps, "UralCivil"];
...
P2DZ_mH = ["2", "The crashsite has been secured by survivors!", _gps, "UralCivil"];
publicVariable "P2DZ_mH";

diag_log text format["[DZMS]: Minor SM6 Ural Crash Mission has Ended."];
