...
P2DZ_mH = ["2", "A group of bandits have set up a stash house!", _gps, "HMMWV_DZ"];
...
_crate1 = createVehicle ["USLaunchersBox",[(_coords select 0) - 5, _coords select 1,0],[], 0, "CAN_COLLIDE"];
...
P2DZ_mH = ["2", "The stash house is under survivor control!", _gps, "HMMWV_DZ"];
publicVariable "P2DZ_mH";
