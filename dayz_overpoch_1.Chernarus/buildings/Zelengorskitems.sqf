...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2555.4353, 5040.814];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2553.3328, 5044.2012];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2550.5112, 5048.6362, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2548.4197, 5052.0063];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2546.3193, 5055.3633, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2544.2249, 5058.708, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2542.1182, 5062.0571, -1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2540.0251, 5065.4053];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2537.9087, 5068.7485, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2535.7971, 5072.103];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2536.3691, 5074.9058, -1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2539.6506, 5077.1572];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2542.9019, 5079.3916, -1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2546.1628, 5081.6338];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2549.3914, 5083.835, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2552.5708, 5083.7163, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2555.6807, 5081.2192];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2557.25, 5078, 3.0517578e-005];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2558.45, 5039.269];
...
if (true) then
{
  _this = "MAP_Wall_Tin_4" createVehicle [2562.1948, 5040.2866];
...
if (true) then
{
  _this = "MAP_CncBlock" createVehicle [2559.1841, 5081.3555];
...
if (true) then
{
  _this = "MAP_CncBlock" createVehicle [2563.2361, 5083.8882, 4.5776367e-005];
...
if (true) then
{
  _this = "MAP_sign_hospital" createVehicle [2468.064, 4946.7729];
...
if (true) then
{
  _this = "MAP_sign_hospital" createVehicle [2667.1206, 5123.0254];
...
if (true) then
{
  _this = "MAP_water_tank" createVehicle [2983.877, 5425.6162, -0.75534153];
...
if (true) then
{
  _this = "Misc_concrete" createVehicle [2608.7927, 5089.1953];
...
if (true) then
{
  _this = "MAP_Misc_G_Pipes" createVehicle [2593.6453, 5097.1162, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Barels3" createVehicle [2595.7427, 5105.7466, -1.5258789e-005];
