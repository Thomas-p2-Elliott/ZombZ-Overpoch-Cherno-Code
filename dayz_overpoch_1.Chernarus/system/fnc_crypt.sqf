...
#ifdef DEBUG_MODE_FULL
	diag_log text format["[%1] fnc_crypt <info>: Trace: Line #%2. Benchmark: %3 sec.", round(diag_tickTime), __LINE__, (diag_tickTime - _startTime)];
#endif
...
#ifdef DEBUG_MODE_FULL
	diag_log text format["[%1] fnc_crypt <info>: Processed: %2 bits. Benchmark: %3 sec.", round(diag_tickTime), (count _bin), (diag_tickTime - _startTime)];
#endif
