...
"PVDZ_OBJ_DEPLOY" addPublicVariableEventHandler {
        ...
        if (_select in ['Old_bike_TK_CIV_EP1','ATV_US_EP1','TT650_TK_CIV_EP1','350z_white_DZ','BTR40_TK_GUE_EP1','BTR40_MG_TK_GUE_EP1','HMMWV_DZ','HMMWV_Armored_DZ','GyroC_DZ','MH6J_DZ','BAF_Merlin_DZ','UH1H_TK_EP1']) then {
...
"PVDZ_OBJ_DEPLOY_PACK" addPublicVariableEventHandler {
		...
		if (typeOf _obj == "BAF_Merlin_DZ") then {
