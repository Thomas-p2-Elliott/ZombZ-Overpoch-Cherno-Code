...
public:
	...
	bool updateObjectGold(int serverId, Int64 objectIdent, bool byUID, const Sqf::Value& goldArray) override;
...
private:
	...
	SqlStatementID _stmtUpdateObjectGoldbyUID;
	SqlStatementID _stmtUpdateObjectGoldbyID;
