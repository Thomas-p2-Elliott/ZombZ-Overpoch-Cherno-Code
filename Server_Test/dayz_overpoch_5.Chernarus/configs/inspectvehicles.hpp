...
class Rsc2LoadingText : Rsc2Text
{
	style = 2;
	x = 0.323532;
	y = 0.666672;
...
class Rsc2Combo
{
	...
	coloRsc2rollbar[] = {0.023529,0,0.0313725,1};
	soundSelect[] = {"",0.1,1};
	soundExpand[] = {"",0.1,1};
	soundCollapse[] = {"",0.1,1};
	maxHistoryDelay = 1;
...
class Rsc2ListBox
{
	...
	rowHeight = 0;
	colorText[] = {0.8784,0.8471,0.651,1};
	coloRsc2rollbar[] = {0.95,0.95,0.95,1};
