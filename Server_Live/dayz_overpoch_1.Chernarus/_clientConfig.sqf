...
if (hasInterface && !isDedicated) then {
	...
	[] spawn {
		...
		_bank13 setMarkerType "Strongpoint";
		...
		_bank15 = createMarker ["DevilsAIText", [6888.728, 11427.035, 1]];
		_bank15 setMarkerText "A.I. Fortress";
		_bank15 setMarkerType "Attack";
		_bank15 setMarkerColor "ColorBlack";
		bank15 = _bank15;
	
		_bank16 = createMarker ["PikKozlovaTrainingGround", [8737.1816, 2335.4153, 1]];
		_bank16 setMarkerText "NATO Training Ground";
		_bank16 setMarkerType "Defend";
		_bank16 setMarkerColor "ColorRedAlpha";
		bank16 = _bank16;
