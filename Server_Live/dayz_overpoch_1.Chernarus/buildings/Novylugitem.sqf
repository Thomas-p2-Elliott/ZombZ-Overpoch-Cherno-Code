...
if (true) then
{
  _this = "MAP_Barels2" createVehicle [9613.2002, 11260.924, 1.5258789e-005];
...
if (true) then
{
  _this = "MAP_Wall_IndCnc_Pole" createVehicle [9593.5176, 11366.564, 0.41129136];
...
if (true) then
{
  _this = "MAP_P_Stavebni_kozy" createVehicle [9488.4766, 11373.889, 6.1035156e-005];
...
if (true) then
{
  _this = "MAP_garbage_misc" createVehicle [9462.2002, 11402.148, -6.1035156e-005];
...
if (true) then
{
  _this = "MAP_ground_garbage_long" createVehicle [9484.125, 11368.598, -7.6293945e-005];
...
if (true) then
{
  _this = "MAP_ground_garbage_long" createVehicle [9482.7529, 11367.187, -3.0517578e-005];
...
if (true) then
{
  _this = "MAP_P_pipe_big" createVehicle [9439.3887, 11372.38, 0.044151206];
...
if (true) then
{
  _this = "MAP_Pallets_Column" createVehicle [9437.3564, 11372.636, -6.1035156e-005];
...
if (true) then
{
  _this = "MAP_Wall_IndCnc_Pole" createVehicle [9527.7266, 11397.737, -0.2222299];
...
if (true) then
{
  _this = "MAP_Wall_IndCnc_Pole" createVehicle [9544.8926, 11425.758, 0.47519058];
...
if (true) then
{
  _this = "MAP_Wall_VilVar2_4_D" createVehicle [9418.5225, 11357.896, 6.1035156e-005];
