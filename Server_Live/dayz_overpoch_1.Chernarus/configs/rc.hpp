class ExtraRc {
    ...
    class Binocular_Vector  {
		...
		class distance400m {
			text = "400 Meters";
			script = "setViewDistance 400; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 400'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance600m {
			text = "600 Meters";
			script = "setViewDistance 600; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 600'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance800m {
			text = "800 Meters";
			script = "setViewDistance 800; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 800'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance1000m {
			text = "1000 Meters";
			script = "setViewDistance 1000; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 1000'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance1250m {
			text = "1250 Meters";
			script = "setViewDistance 1250; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 1250'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance1500m {
			text = "1500 Meters";
			script = "setViewDistance 1500; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 1500'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance2000m {
			text = "2000 Meters";
			script = "setViewDistance 2000; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 2000'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
		class distance3000m {
			text = "3000 Meters";
			script = "setViewDistance 3000; player setVariable ['P2_viewDist', viewDistance, true]; systemChat('ViewDistance: 3000'); systemChat('Warning: Higher the view distance Lower the FPS');";
		};
	};
	class Binocular {
		class viewdistanceTitle {
